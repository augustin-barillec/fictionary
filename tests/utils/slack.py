...
def list_channels(slack_client):
    resp = reusable.slack_api.conversations_list(slack_client)
...
def list_members(slack_client, channel_id):
    resp = reusable.slack_api.conversations_members(
...
def create_channel(slack_client, channel_name):
    ...
    resp = reusable.slack_api.conversations_create(
...
def kick(slack_client, channel_id, user_ids):
    ...
    for user_id in user_ids:
        ...
        reusable.slack_api.conversations_kick(
...
def invite(slack_client, channel_id, user_ids):
    ...
    for user_id in user_ids:
        ...
        reusable.slack_api.conversations_invite(
            slack_client, channel_id, user_id)
...
def join(slack_client, channel_id):
    ...
    reusable.slack_api.conversations_join(slack_client, channel_id)
    logger.info(f'Ended join {channel_id}')


def leave(slack_client, channel_id):
    logger.info('Starting leave...')
    reusable.slack_api.conversations_leave(slack_client, channel_id)
