describe('main', () => {
  it('main', () => {
    cy.get_conf().then((conf) => {
      cy.get_channel_id('french_exception_slash_command_max_running').then((channel_id) => {
        ...
        cy.contains("Il y a déjà 3 parties en cours. C'est le nombre maximal autorisé.")
